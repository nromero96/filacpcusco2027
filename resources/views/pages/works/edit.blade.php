                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area pt-0">
                        ...
                        <form class="row g-3" action="{{ route('works.update',$work->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <label for="inputDescription" class="form-label fw-bold">{{__("Cuerpo del trabajo")}} (<a href="https://my.bolivarianofilacpcusco2027.org/wp-content/uploads/2023/09/Bases-para-presentacion-de-trabajos-FILA-2024.pdf" target="_blank"><small class="text-info text-decoration-underline">{{ __('Síga las instrucciones de las bases.') }}</small></a>)</label>
