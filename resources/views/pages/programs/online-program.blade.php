...
<head>
    ...
    <style>
        ...
        .audio::before{
            content: '';
            background-image: url(https://my.bolivarianofilacpcusco2027.org/assets/img/audifono-45374.png);
...
<body>
    ...
    <section class="headepage pt-5 pb-5">
        ...
        <div class="titlepage">
            <div class="container-fluid text-center text-white">
                ...
                <a href="https://bolivarianofilacpcusco2027.org" class="btn btn-primary">
            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td class="align-middle bg-col-6">
                        <b>REUNIÓN OFICIAL BECADOS FILACP 2027</b>
                    </td>
                    <td>CIERRE</td>
                    <td>CIERRE</td>
                    <td></td>
    ...
    <div class="text-center">
        ...
        <a href="https://my.bolivarianofilacpcusco2027.org/wp-content/uploads/2024/04/version-final-Programa-General-filacp-2024-publicacion-220424.pdf" target="_blank" class="btn btn-des-program">Descargar Programa</a>
        <a href="https://my.bolivarianofilacpcusco2027.org/wp-content/uploads/2024/04/AGENDA-DETALLADA-Y-PROGRAMA-GENERAL-FILACP-LIMA-2024-V-220424.pdf" target="_blank" class="btn btn-des-program">Descargar Agenda Detallada</a>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pt-1">
                    ...
                    <p class="text-center">
                        <img id="img_session" src="https://my.bolivarianofilacpcusco2027.org/storage/uploads/program_file/loading_icon.gif" alt="Programa" class="img-fluid">
                    </p>
                    <p class="text-center">
