                            ...
                            <div class="col-md-12">
                                <div class="text-center" style="font-size:17px;">
                                    ...
                                    <div>
                                        ...
                                        <label for="confirmPay" style="font-size: 15px;">{{__("Confirmo que he leído y acepto los")}} <a href="https://bolivarianofilacpcusco2027.org/inscripciones/" target="_blank">{{__("Términos y Condiciones")}}</a> {{__("y la")}} <a href="https://bolivarianofilacpcusco2027.org/inscripciones/" target="_blank">{{__("Política de Privacidad")}}</a></label>
                                    </div>
